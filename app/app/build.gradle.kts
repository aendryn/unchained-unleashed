...
dependencies {
    ...
    // Installs the bundled Baseline Profile on first run so hot startup/scroll paths are precompiled.
    implementation(libs.androidx.profileinstaller)
    // Consumes the profile generated by the :baselineprofile module into the release build.
